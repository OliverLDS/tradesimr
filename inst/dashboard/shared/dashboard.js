...
function render() {
  ...
  renderTable("inventory-positions-table", state.tables.inventory_positions, ["timestamp", "agent_id", "symbol", "asset_id", "currency", "units", "average_cost", "last_price", "accrued_interest", "market_value_base", "unrealized_pnl_base"], 80);
