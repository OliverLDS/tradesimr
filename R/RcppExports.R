...
step_rcpp <- function(state, timestamp, open, high, low, close, action, dir, order_type, ctr_qty, price, strat_id, action_id, asset = 0L, ctr_size = 1.0, ctr_step = 1.0, lev = 10.0, fee_rt = 0.0, maker_fee_rt = NA_real_, taker_fee_rt = NA_real_, fund_rt = 0.0, funding_interval_hours = 8.0, mmr = 0.02, old_timestamp = NA_real_, slippage = 0.0, spread = 0.0, rec = TRUE) {
